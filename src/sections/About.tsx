...
import mapImage from "@/assets/images/map_addis.png";
      ...
      <div className="container">
        ...
        <div className="mt-20 flex flex-col gap-8">
          <div className="grid grid-col-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
            ...
            <Card
              className="h-[320px] p-0 md:col-span-3 lg:col-span-2
            "
            >
              <CardHeader
                title="My Toolbox"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              >
               ...
               from-emerald-300 to-sky-400 -z-20 animate-ping [animate-duration:2s]"
                ></div>
                <div
                  className="absolute inset-0 rounded-full bg-gradient-to-r
